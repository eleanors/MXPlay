...
(function() {
        ...
        var force = function(name, object, methods) {
                ...
                if (isType) {
                        ...
                        object.forEachMethod = function(fn) {
                                if (!methodsEnumerable) for (var i = 0,
                                l = methods.length; i < l; i++) {
        ...
        force('String', String, ['charAt', 'charCodeAt', 'concat', 'contains', 'indexOf', 'lastIndexOf', 'match', 'quote', 'replace', 'search', 'slice', 'split', 'substr', 'substring', 'trim', 'toLowerCase', 'toUpperCase'])
		
		('Array', Array, ['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift', 'concat', 'join', 'slice', 'indexOf', 'lastIndexOf', 'filter', 'forEach', 'every', 'map', 'some', 'reduce', 'reduceRight', 'contains'])
		
		('Number', Number, ['toExponential', 'toFixed', 'toLocaleString', 'toPrecision'])
		
		('Function', Function, ['apply', 'call', 'bind'])
		
		('RegExp', RegExp, ['exec', 'test'])
		
		('Object', Object, ['create', 'defineProperty', 'defineProperties', 'keys', 'getPrototypeOf', 'getOwnPropertyDescriptor', 'getOwnPropertyNames', 'preventExtensions', 'isExtensible', 'seal', 'isSealed', 'freeze', 'isFrozen'])
        ...
        Object.extend({
                ...
                keys: function(object) {
                        ...
                        /*<ltIE8>*/
                        forEachObjectEnumberableKey(object,
                        function(k) {
                                keys.push(k);
                        });
                        /*</ltIE8>*/
...
Array.implement({
        ...
        filter: function(fn, bind) {
                var results = [];
                for (var value, i = 0,
                l = this.length >>> 0; i < l; i++) if (i in this) {
                        value = this[i];
...
; (function() {
        ...
        local.setDocument = function(document) {
                ...
                if (features.isHTMLDocument) {
                        ...
                        features.nativeMatchesSelector = root.matches ||
                ...
                features.contains = (nativeRootContains && nativeDocumentContains) ?
        ...
        local.search = function(context, expression, append, first) {
                ...
                if (typeof expression == 'string') { // expression is a string
                        ...
                        querySelector: if (context.querySelectorAll) {
                                ...
                                && expression.indexOf(',') > -1) || Slick.disableQSA) break querySelector;
...
var Element = this.Element = function(tag, props) {
        ...
        if (! (/^[\w-]+$/).test(tag)) {
                ...
                if (attributes) for (var attr, i = 0,
        ...
        Element.implement({
                ...
                getStyle: function(property) {
                        ...
                        if (hasBackgroundPositionXY && /^backgroundPosition[XY]?$/.test(property)) {
                                return result.replace(/(top|right|bottom|left)/g,
                                function(position) {
...
(function() {
		...
		withCredentials: false,*/
                ...
                send: function(options) {
                        ...
                        this.options.user ||
                        /*</1.4compat>*/
                        this.options.withCredentials) && 'withCredentials' in xhr) xhr.withCredentials = true;
        ...
        var methods = {}; ['get', 'post', 'put', 'delete', 'patch', 'head', 'GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'HEAD'].each(function(method) {
